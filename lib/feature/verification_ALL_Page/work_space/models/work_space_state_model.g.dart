...
_$WorkSpaceStateModelImpl _$$WorkSpaceStateModelImplFromJson(
        Map<String, dynamic> json) =>
    _$WorkSpaceStateModelImpl(
      ...
      response: json['response'] == null
          ? null
          : WorkStateResponseModel.fromJson(
              json['response'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$WorkSpaceStateModelImplToJson(
        _$WorkSpaceStateModelImpl instance) =>
    <String, dynamic>{
